...
| 2026-07-13 | programmers | [lv3/001_네트워크](problems/programmers/lv3/001_네트워크/) | ★★★ | 🟡 출제됨 | - | 인접 행렬 그래프 DFS(연결 요소). ⏸ 격자 DFS 익힌 뒤 도전 예약 |
| 2026-07-13 | custom | [002_섬_넓이_목록](problems/custom/002_섬_넓이_목록/) | ★★☆ | 🟡 출제됨 | - | 격자 DFS 복습(넓이 전부 모아 정렬, max→append) |
