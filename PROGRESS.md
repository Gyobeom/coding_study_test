...
| 2026-07-31 | programmers | [lv1/007_키패드_누르기](problems/programmers/lv1/007_키패드_누르기/) | ★☆☆ | 🟢 통과 | 9/9 | 구현: 키패드를 flat list로 두고 idx//3·idx%3 좌표화, 맨해튼 거리 비교. 참조 2만건 대조 |
| 2026-07-31 | programmers | [lv1/008_크레인_인형뽑기_게임](problems/programmers/lv1/008_크레인_인형뽑기_게임/) | ★★☆ | 🟢 통과 | 8/8 | 구현·스택: 열마다 위에서 첫 인형 뽑아 스택, top과 같으면 pop+2. 참조 2만건 |
| 2026-07-31 | programmers | [lv2/019_주차_요금_계산](problems/programmers/lv2/019_주차_요금_계산/) | ★★☆ | 🟢 통과 | 7/7 | 구현: 함수 3분할(dict 누적·미출차 23:59·올림 요금). 참조 2만건. 코드리뷰: 부작용 클로저→입출력 반환형 권장 |
| 2026-07-20 | programmers | [lv2/020_행렬_테두리_회전하기](problems/programmers/lv2/020_행렬_테두리_회전하기/) | ★★☆ | 🟡 출제됨 | - | 시뮬레이션 복습: 테두리 시계 회전 |
| 2026-07-31 | custom | [005_섬_둘레_구하기](problems/custom/005_섬_둘레_구하기/) | ★★☆ | 🟢 통과 | 8/8 | 복습(DFS 격자). 디버깅: dfs에 델타 대신 좌표, 이웃 3갈래. [재]간격반복 백지 재풀이 시 visited 배열 분리(원본 오염 제거)로 개선. 참조 1.5만건 |
| 2026-07-31 | custom | [006_장애물_격자_최단거리](problems/custom/006_장애물_격자_최단거리/) | ★★☆ | 🟢 통과 | 8/8 | 복습(BFS, 학습문서 안 봄). 디버깅: ①시작/도착 벽이면 -1 ②도착 만난 순간 cnt 반환(마지막 cnt 아님). 참조 4만건 |
| 2026-07-31 | custom | [007_스트림_K번째_작은_수](problems/custom/007_스트림_K번째_작은_수/) | ★★☆ | 🟢 통과 | 8/8 | 복습(힙): heapify 후 k번 pop. 참조 2만건 |
| 2026-07-31 | custom | [008_최소_적재량_이분탐색](problems/custom/008_최소_적재량_이분탐색/) | ★★☆ | 🟢 통과 | 8/8 | 복습(파라메트릭). 디버깅: count_truck(sum_val=weight·첫트럭 카운트) + while lo<hi 이분탐색(mid<=D→hi=mid, else lo=mid+1). 참조 2만건 |
| 2026-09-17 | custom | [009_회의실_최대_배정](problems/custom/009_회의실_최대_배정/) | ★★☆ | 🟢 통과 | 8/8 | 복습(그리디): 끝나는 시간→시작 시간 정렬 후 한 번 순회, O(N log N) |
| 2026-07-20 | custom | [010_목표합_조합_개수](problems/custom/010_목표합_조합_개수/) | ★★☆ | 🟡 출제됨 | - | 복습(백트래킹): 부분집합 합=target 개수 |
| 2026-09-14 | custom | [011_애너그램_그룹_수](problems/custom/011_애너그램_그룹_수/) | ★★☆ | 🟢 통과 | 9/9 | 복습(해시): 각 단어를 정렬한 문자열을 키로 사용해 서로 다른 키의 수 반환 |
| 2026-08-01 | custom | [012_괄호_최대_깊이](problems/custom/012_괄호_최대_깊이/) | ★☆☆ | 🟢 통과 | 9/9 | 복귀 복습(스택). 디버깅: 닫을 때 깊이 하강 누락 → 여는 괄호마다 max(len(stack)) 갱신. 참조 2만건 |
| 2026-09-15 | custom | [013_학생_다중키_정렬](problems/custom/013_학생_다중키_정렬/) | ★★☆ | 🟢 통과 | 9/9 | 복습(정렬): 점수↓·이름↑ 튜플 key |
| 2026-07-20 | custom | [014_서브트리_노드수](problems/custom/014_서브트리_노드수/) | ★★☆ | 🟡 출제됨 | - | 복습(DFS 반환형): 서브트리 크기 |
| 2026-07-20 | custom | [015_다중_발화점_확산시간](problems/custom/015_다중_발화점_확산시간/) | ★★☆ | 🟡 출제됨 | - | 복습(다중 시작 BFS): 전부 젖는 최소 시간, 불가 -1 |
| 2026-07-20 | custom | [016_부분집합_최대합_제한](problems/custom/016_부분집합_최대합_제한/) | ★★☆ | 🟡 출제됨 | - | 복습(완전탐색): 합 limit 이하 최대 |
